...
ESPGHAN_2022_DEFAULTS = {
    ...
    "vitamin_a_per_kg": 1500.0, "vitamin_a_per_kg_max": 1500.0,
    "vitamin_d_per_kg": 800.0,  "vitamin_d_per_kg_max": 1000.0, # total/day
    "vitamin_c_per_kg": 0.0,    "vitamin_c_per_kg_max": 0.0,    # no guideline
    "folic_acid_per_kg": 0.0,   "folic_acid_per_kg_max": 0.0,   # no guideline
    "vitamin_b12_per_kg": 0.0,  "vitamin_b12_per_kg_max": 0.0,  # no guideline
...
@router.get("/baby/{baby_id}/daily", response_model=schemas.TargetSetting)
